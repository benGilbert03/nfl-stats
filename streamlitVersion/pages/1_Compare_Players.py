...
def nextPair():
    if not st.session_state['indexesToCompare'] == []:
        ...
        print(f'key 1 = col{st.session_state['cols'][0]}')
        print(f'key 2 = col{st.session_state['cols'][1]}')
...
if 'players' in st.session_state:
    if st.session_state['players'].empty:
        ...
        if 'indexesToCompare' not in st.session_state:
